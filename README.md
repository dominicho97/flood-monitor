...
This project is an end-to-end **Flood Monitoring System** built using **Azure Services**. It integrates real-time data from the [Flood Monitoring API](https://environment.data.gov.uk/flood-monitoring/doc/reference) and provides actionable insights using **interactive dashboards**.
